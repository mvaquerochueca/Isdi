...
const calculator = (...numbers) => {
  ...
  if (numbers.length === 1) {
    ...
    console.log(`La suma de ${numbers[0]} y ${numbers[1]} es ${sum.toFixed(3)}.`);
    console.log(`La resta de ${numbers[0]} y ${numbers[1]} es ${subtraction.toFixed(3)}.`);
    console.log(`El producto de ${numbers[0]} y ${numbers[1]} es ${multiplication.toFixed(3)}.`);
    console.log(`La división de ${numbers[0]} entre ${numbers[1]} es ${division.toFixed(3)}.`);
  } else {
